...
class IndexModel:
    ...
    def __init__(self) -> None:
        ...
        #importing dataset
        data=pd.read_csv("/Users/adamnovak/Desktop/code/data_sources/stock_prices.csv")
        data.insert(1,"Datetime", self.date_transform(data.iloc[:,0]))
        self.data=data

        
    def date_transform(self, date_array):
    ...
    def export_values(self, file_name: str) -> None:
        self.index_dataframe.to_csv(file_name,index=False)
